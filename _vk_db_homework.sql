...
DROP TABLE IF EXISTS uaddresses;
...
CREATE TABLE videos (
	id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY, 
    own_id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY, 
    own_firstname VARCHAR(50),
    own_lastname VARCHAR(50),
    ...
    FOREIGN KEY (own_id) REFERENCES users(id),
    FOREIGN KEY (own_firstname) REFERENCES users(firstname),
    FOREIGN KEY (own_lastname) REFERENCES users(lastname)
);
